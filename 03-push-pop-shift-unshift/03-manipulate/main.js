...
animals.push('Fish'); // add string ไว้หลัง array
console.log(animals); // ['Dog', 'Cat', 'Rat', 'Fish']

animals.unshift('Horse'); // add string ไว้หน้า array 
console.log(animals);

animals.push('Giraffe','Snake') // add string ไว้หลัง array
console.log(animals);

animals.shift(); // delete element ด้านหน้า
console.log(animals);

animals.pop(); //
console.log(animals);

 console.log(animals); // ['Cat', 'Rat', 'Fish', 'Giraffe', 'Snake']
